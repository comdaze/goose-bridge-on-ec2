 ...
 *
 */
typedef bool (*EditSettingGroupConfirmationHandler) (void* parameter, SettingGroupControlBlock* sgcb,
        uint8_t editSg);//此处为变更的代码
...
//#if (CONFIG_IEC61850_CLOSE_CONNECT_MODIFICATION == 1)
//void IedServer_closeAllOpenClientConnections(IedServer self); //hyc 20181129 //修改的代码---暂时不要
//#endif
